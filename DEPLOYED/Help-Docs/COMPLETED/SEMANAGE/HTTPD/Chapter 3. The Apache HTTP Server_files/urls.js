 ...
 * @see https://mojo.redhat.com/docs/DOC-179012
 * @author Michael Clayton <mclayton@redhat.com>
 * @copyright Red Hat 2013-2014
 */
define(['analytics/attributes'], function (attributes, undefined) {
	"use strict";
	 ...
	 * as arguments.
	 *
	 * See {@link https://mojo.redhat.com/docs/DOC-179012 the URL Doc} for the
	 * specification that defines all the URL patterns.
	 *
	...
	url_definitions = [
		...
		// TODO get this added to the URL doc:
		...
		{
			regex           : /^\/+support\/+cases\/+list([^\/+]+)\/*([?#].*)?$/,
			platform        : PLATFORMS.PCM,
			collection      : COLLECTIONS.SUPPORT_CASES,
			persona         : PERSONAS.CONSUMER,
			resource_type   : "case-list",
			get_resource_id : undefined,
			get_page_name   : function () {
				return [this.Platform, this.ResourceType, "CaseList"];
			}
		},

		{
			regex           : /^\/+support\/+cases\/+list\/+open\/*([?#].*)?$/,
			platform        : PLATFORMS.PCM,
			collection      : COLLECTIONS.SUPPORT_CASES,
			persona         : PERSONAS.CONSUMER,
