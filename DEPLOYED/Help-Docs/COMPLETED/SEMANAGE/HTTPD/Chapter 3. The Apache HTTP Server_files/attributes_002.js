 ...
 */
define(['jquery', 'underscore', 's_code', 'jsUri', 'require', 'user_info', 'chrome_lib',  'analytics/adapters/omniture/old_fns'], function ($, _, s_code, jsUri, require, user_info, lib) {
	"use strict";
		 ...
		 *********************************************************************/
		{
			...
			getter : function () {
				...
				if (chrome_session_id) {
					chrome_session_id = chrome_session_id.replace(/\|/, ' | ') || "";
				}
