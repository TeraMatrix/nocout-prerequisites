 ...
 */
define(['analytics/adapters/omniture/old_props', 's_code'], function () {
    ...
    var NAME      = "omniture",
         ...
         */
        prefix    = { cp: "cp | " },
        separator = { pipe: " | ", resource: "-", comma: ', ', semicolon: ';' },
    ...
    function prep_value(attribute_name, value) {
        var retval,
            ...
            attr_separator = has_separator ? separator[mapped_attr.separator] : separator.pipe,
