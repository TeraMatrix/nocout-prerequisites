 ...
 */
define(['analytics/url', 'analytics/sites/portal/urls', 'analytics/attributes', 'chrome_lib', 'jquery'], function (url, portal_urls, attributes, lib, $) {
		...
		$(function () {
			lib.whenUserStatusReady(function () {
				...
				require(report_deps, function (attributes, lib) {
					...
					if (any_undefined.apply(this, arguments)) { return; }
	...
	function init(adapters_arg) {
		...
		// https://mojo.redhat.com/docs/DOC-179012
	...
	/**
	 * Returns true if every argument passed into it is defined.  This is used
	 * to ensure that all require'd dependencies are defined.  In certain
	 * cases, browser plugins will block requests to some of our scripts.
	 * Scripts whose names contain 'omniture' or 'eloqua' get blocked by
	 * DoNotTrackMe for Chrome, for example.
	 */
